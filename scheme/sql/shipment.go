...
func ConvertToShipments(scheme []Field, data []map[string]string) ([]SqlConverter, error) {
...
func (s Shipment) Convert(scheme []Field, data map[string]string) (c SqlConverter, err error) {
