...
SELECT
	_shipment._IDRRef as ref,
	_shipment._Fld17149RRef as doctor
INTO #shipments
FROM dbo._Document431 _shipment WITH(NOLOCK)
WHERE  _shipment._Posted = 0x01 
	AND (_shipment._Fld10606_TYPE = 0x08 AND _shipment._Fld10606_RTRef = 0x0000016F AND _shipment._Fld10606_RRRef = @emptyRef) 
	AND _shipment._Fld10607RRef <> @clinic
	AND _shipment._IDRRef = @shipment

SELECT 
	CONVERT(VARCHAR(40), t2._Document431_IDRRef,2) AS ref,
	CASE 
...
INTO #segments
FROM #shipments t1 WITH(NOLOCK)
LEFT OUTER JOIN dbo._Document431_VT10659 t2 WITH(NOLOCK)
LEFT OUTER JOIN dbo._Reference286 t3 WITH(NOLOCK)
ON t2._Fld10661RRef = t3._IDRRef AND t2._Fld10661RRef = t3._IDRRef
ON t1.ref= t2._Document431_IDRRef
LEFT OUTER JOIN dbo._Reference286 t4 WITH(NOLOCK)
ON t2._Fld10661RRef = t4._IDRRef 
